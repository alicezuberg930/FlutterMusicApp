...
class _PlayListDetailsScreenState extends State<PlayListDetailsScreen> {
  ...
  getPlaylist() async {
    ...
    for (Song song in playlist!.songs) {
      ...
      Song? songInfo = await apiService.getInfo(encodeId: song.encodeId!);
      if (songInfo!.q128 != null) song.q128 = songInfo.q128;
    }
                      ...
                      onPressed: () {
                        audioPlayer.setAudioSource(
                          ConcatenatingAudioSource(
                            children: [
                              for (Song song in playlist!.songs) AudioSource.uri(Uri.parse(song.q128!)),
                            ],
                          ),
                          initialIndex: 0,
                        );
